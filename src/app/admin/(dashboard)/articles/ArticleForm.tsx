    ...
    <form action={action} className="grid grid-cols-1 lg:grid-cols-[1fr_260px] gap-6 items-start">
      <div className="min-w-0">
        ...
        <div className="mb-5">
          ...
          <TranslationPicker candidates={translationCandidates} defaultValue={article?.translationRefId} />
        </div>
        ...
        <details className="bg-[var(--admin-panel)] border border-[var(--admin-border)] rounded-xl mb-6" open>
          ...
          <div className="px-4 pb-4 border-t border-[var(--admin-border)] pt-4">
            ...
            <div className="mb-3">
              ...
              <TagChipsInput name="seoKeywords" defaultValue={article?.seoKeywords ? article.seoKeywords.split(',').map(s => s.trim()).filter(Boolean) : []} minRecommended={10} />
            </div>
            <div className="mb-3">
