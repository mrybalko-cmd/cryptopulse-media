...
export default function TemaDnyaCard({ article, locale }: TemaDnyaCardProps) {
  ...
  return (
    <Link
      ...
      className="group relative block w-full max-w-[560px] aspect-[160/117] lg:aspect-auto lg:h-full lg:min-h-[240px] rounded-xl overflow-hidden border border-border/70 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
    >
      {article.coverImage && (
        <Image
