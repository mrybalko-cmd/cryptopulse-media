...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = isRu
    ? `Статьи ${SITE_NAME}, которые читатели отметили лайком чаще всего.`
    : `${SITE_NAME} articles readers have liked the most.`;
  return {
    title,
    description,
    ...
    alternates: {
      ...
      languages: { ru: `${BASE}/ru/articles/popular`, en: `${BASE}/en/articles/popular`, 'x-default': `${BASE}/en/articles/popular` },
    },
  };
}
