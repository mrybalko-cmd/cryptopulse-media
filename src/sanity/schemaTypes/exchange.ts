      ...
      of: [
        {
          ...
          fields: [
            defineField({
              ...
              validation: Rule => Rule.required(),
              description: 'Показывается и на плитке (десктоп), и на полосе (мобильный). Рекомендуется альбомная ориентация, например 800×600.',
            }),
            ...
            defineField({
              ...
              options: {
                list: [
                  ...
                  { title: '🟡 Предупреждение (жёлтый)', value: 'warn' },
                  { title: '⚪ Нейтральный (серый)', value: 'off' },
                  { title: '🏆 Золотой / доверие', value: 'gold' },
                ],
              },
              initialValue: 'off',
              validation: Rule => Rule.required(),
