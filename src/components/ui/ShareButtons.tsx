...
export default function ShareButtons({ url, title, locale, vertical = true }: ShareButtonsProps) {
  ...
  const btnClass =
    'tap-target w-9 h-9 rounded-full border border-border flex items-center justify-center text-muted hover:bg-share-hover hover:border-share-hover hover:text-foreground transition-colors';
